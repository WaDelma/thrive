...
<@pp.nestOutputFile name = "BenchmarkLinearIterator_${structure.name}.java">
...
@State(Scope.Thread)
public class BenchmarkLinearIterator_${structure.name} {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(BenchmarkLinearIterator_${structure.name}.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}
